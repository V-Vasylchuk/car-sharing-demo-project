...
import './user.scss'
import { getBearerToken, setToken } from '../../config';
...
function User() {
  ...
  return (
    <div className="user-container">
      <img className='img_user' src="https://freesvg.org/img/abstract-user-flat-4.png" alt="" width={"20px"} onClick={handleUserClick} />
